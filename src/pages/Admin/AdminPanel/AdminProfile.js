...
const PWD_REGEX = /^(?=.*[A-Z])(?=.*[a-z])(?=.*\d)(?=.*[@$!%*?&#])[A-Za-z\d@$!%*?&#]{7,40}$/;
function AdminProfile() {
        ...
        try {
            ...
            const organisationId =
                form.organisationId === "Other"
                    ? null
                    : parseInt(form.organisationId, 10);

            const organisation = organisationId === null
                ? {
    ...
    return (
        ...
        <div className="overflow-hidden ">
            <Sidebar open={openSidebar} value={openSidebar} setValue={setOpenSidebar} />
                    ...
                    <div className="relative grid grid-cols-1 text-sm border lg:grid-cols-12 font-Lexend_Regular">
                        ...
                        <div className="col-span-8 p-4 border">
                            ...
                            <div className="grid grid-cols-1 border rounded-b-lg sm:grid-cols-2 font-Lexend_Regular">
                                ...
                                {/* Organisation Type */}
                                <div className="px-4 py-2 ">
                                    <h2 className="">Organisation Type</h2>
                                    <div className="">
                                        {isEditing ? (
                                            <select
                                ...
                                <div className="px-4 py-2 ">
                                    <label htmlFor="organisation" className="">
                                        {form.organisationType === "College" ? " College" : form.organisationType === "School" ? "School" : form.organisationType === "Corporate" ? "Corporate Organisation" : "Goverment Organisation"}
                                    </label>
                                    <div className="">
                                        {isEditing && form.organisationType !== "" ? (
                                            ...
                                            <p className="w-full px-2 py-1 text-sm border rounded">{form.organisationName || "N/A"}{form.organisationPlace && ","} {form.organisationPlace || ""}</p>
                                        )}
                                    </div>
                                </div>
                                {/* Organisation name*/}
                                {form.organisationId === "Other" &&
                                    <div className="px-4 py-2 ">
                                        <label htmlFor="organisationName" className="">
                                            {form.organisationType === "College" ? " College" : form.organisationType === "School" ? "School" : form.organisationType === "Corporate" ? "Corporate Organisation" : "Goverment Organisation"} Name
                                ...
                                {form.organisationId === "Other" &&
                                    <div className="px-4 py-2 ">
                                        <label htmlFor="organisationPlace" className="">
                                            {form.organisationType === "College" ? " College" : form.organisationType === "School" ? "School" : form.organisationType === "Corporate" ? "Corporate Organisation" : "Goverment Organisation"} Place
                                ...
                                {/* LevelInfo */}
                                <div className="px-4 py-2 ">
                                    <h2 className="">{form.userType === "Student" && form.organisationType === "School" ? "Class" : form.userType === "Student" && form.organisationType === "College" ? "Course" : "Designation"}</h2>
                            ...
                            {showModal && (
                                <ChangePasswordModal axiosInstance={axiosInstance} setShowModal={setShowModal} toast />
                            )}
                            ...
                            />
                            <IdentityCardModal isOpen={showIdentityCardModal} onClose={() => setShowIdentityCardModal(false)} axiosInstance={axiosInstance} />
...
const ImageModal = ({
    ...
    const handleFileChange = async (event) => {
        ...
        if (file) {
            await uploadImage(file); // only attempt to upload
        }
    };
    ...
    const uploadImage = async (file) => {
        ...
        try {
            ...
            toast.success(res.data || "Profile picture uploaded successfully!");
        } catch (error) {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black bg-opacity-40">
            <div className="bg-white w-full max-w-xl rounded shadow-lg overflow-y-auto max-h-[90vh]">
...
const IdentityCardModal = ({ isOpen, onClose, axiosInstance }) => {
...
function ChangePasswordModal({ setShowModal, axiosInstance }) {
    ...
    useEffect(() => {
        setValidCurrentPassword(PWD_REGEX.test(currentPassword));
    }, [currentPassword]);
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center text-sm bg-black bg-opacity-40 font-Lexend_Regular">
            <div className="bg-white w-[447px] rounded shadow-lg">
                ...
                <div className="grid grid-cols-1 px-6 pb-6 font-Lexend_Regular gap-y-4">
                    ...
                    <div className="relative flex flex-col">
                        <label htmlFor="current-password" className="mb-1 font-Lexend_SemiBold">
                            Current Password
                        </label>
                    ...
                    <div className="relative flex flex-col">
                        ...
                        {newPasswordFocus && newPassword && !validNewPassword && (
                            <p className="mt-1 text-sm text-red-500">
                                Password must be 8-40 characters with uppercase, lowercase, number, and special character.
                            </p>
                        )}
                    </div>
