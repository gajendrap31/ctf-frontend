...
function AdminNotification({ userDetails }) {
    ...
    return (
        <div className=" overflow-hidden">
            ...
            <div className="w-full flex flex-col  overflow-hidden  ">
                ...
                <div className={`text-gray-900 min-h-lvh flex flex-col font-Lexend_SemiBold text-2xl justify-center items-center w-full ${open ? 'pl-0 lg:pl-72' : ''} `} >
