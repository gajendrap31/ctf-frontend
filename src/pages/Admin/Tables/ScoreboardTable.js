                ...
                <tbody>
                    {selectedEvent ? (
                        isLoading ? (
                            ...
                            <tr>
                                <td colSpan="5" className="py-2 text-center text-gray-500 border-b-2">No score available.</td>
                            </tr>
                        )
                    ) : (
                        <tr>
        ...
        <div className="block mt-4 space-y-4 sm:hidden font-Lexend_Regular">
            ...
            {selectedEvent ? (
                isLoading ? (
                    ...
                    <p className="p-2 text-center text-gray-500 bg-white border rounded shadow font-Lexend_Regular">No score available.</p>
                )
            ) : (
